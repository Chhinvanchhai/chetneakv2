...
import 'package:chetneak_v2/controllers/resort_controller.dart';
                      ...
                      body: Container(
                        child: Obx(() => ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                final int count =
                                    resortController.resortList.length > 10
                                        ? 10
                                ...
                                return HotelListView(
                                  callback: () => Get.toNamed('/hoteldetial',
                                      arguments:
                                          resortController.resortList[index]),
              ...
              children: <Widget>[
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Obx(
                      () => Text('${resortController.totalHotel} hotels found',
                          style: TextStyle(
                            fontWeight: FontWeight.w100,
                            fontSize: 16,
                          )),
