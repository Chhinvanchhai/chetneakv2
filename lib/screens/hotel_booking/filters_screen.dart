...
class _FiltersScreenState extends State<FiltersScreen> {
  ...
  ResortController resortController = Get.find();
              ...
              child: Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      resortController
                          .getResortList(resortController.distances);
  ...
  Widget distanceViewUI() {
    return Column(
      ...
      children: <Widget>[
        ...
        SliderView(
          distValue: resortController.distances,
          onChangedistValue: (double value) {
            resortController.distances = value;
          },
        ),
        const SizedBox(
          height: 8,
